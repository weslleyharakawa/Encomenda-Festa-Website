...
/*mainnn inc files */
$lang_email_thanks="Obrigado por assinar nosso boletim!";
$lang_emailexist_error="Ocorreu um erro!";
$lang_emailexist_adress="O e-mail {email} já existe em nossa lista.";
$lang_emailexist_adress_error="O e-mail {email} Não existe em nossa lista. ";
$lang_emailreg_verify="Uma mensagem foi enviada para {email} por favor verifique o link que lhe foi enviado.";
$lang_emailreg_done="O e-amil {email} foi adicionado com sucesso a nossa lista.";
$lang_emailremove_removed="E-mail removido";
$lang_emailremove_adress="O e-mail {email} foi removido com sucesso de nossa lista.";
/*Sending */
